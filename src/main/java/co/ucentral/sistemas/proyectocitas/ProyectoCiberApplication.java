...
@Log4j2
public class ProyectoCiberApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(ProyectoCiberApplication.class, args);
	}
	...
	public ProyectoCiberApplication(RepositorioServicio repositorioServicio, RepositorioCliente repositorioCliente, RepositorioEmpleado repositorioEmpleado, RepositorioSede repositorioSede) {
